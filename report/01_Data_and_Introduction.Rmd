...
# Load the data 
library(here)
data=read.csv("who_data.csv", stringsAsFactors = FALSE)
```
...
Turning your attention to our report, you will see how we choose which predictive models to use in our 'competition', and a careful evaluation of each one. 
