...
Clearly we can see most of our data is clustered around the lower left of our data set, with the exception of a few outliers such as France, Israel, Ireland and Italy, removing these would increase the model performance, however this would also introduce a bias to our model. Our lines indicate ..,
