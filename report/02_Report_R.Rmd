...
train_index_clean <- createDataPartition(clean_europe_data$pm10_concentration, p = 0.9, list = FALSE) #we create a 90-10 split
...
modelcv=train(lm_formula_pm10, data = clean_data_europe_reg, method = "lm" ,trControl=trainControl(method = "cv",number=10))
