...
We decided to use RMSE, R^2 and MAE to evaluate accuracy between our models, since these are a good indicator of predictive error in our pollution concentration levels, relevant to public health. 

We prioritised RMSE for model selection, since larger errors in high pollution cities are more impactful in environmental monitoring.

Decide if this is applicable to all of our models? 
...
To assess the performance of our model reliably and ensure its robustness, we must first split our data into two subsets: a test set and a training set. 
