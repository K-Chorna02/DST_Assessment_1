...
To improve our model, we build upon the ideas of linear regression by regularising, this means we penalise larger coefficients in order to control the variance. This can be given by the following mathematical equation: 
