...
## Literature review
I carried out a small literature review to explore which variables were significant in these analyses. My research found that ...
...
This means we can effectively assess how well the model generalises to unseen future data, as we'd expect in a real world scenario, demonstrating its robustness. However, our model may under perform for non-European or after 2021 data due to changes we may not have observed in this historical data, other countries also had a large amount of missing data so it is difficult to identify if they had similar trends.
